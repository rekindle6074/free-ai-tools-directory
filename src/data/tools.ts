...
export const categories: Category[] = [
  ...
  },
  {
    ...
    color: "emerald",
    subCategories: [
      { name: "Free Text to Image", tag: "free-text-to-image", path: "free-text-to-image", count: 44 },
      { name: "Free AI Photo Editor", tag: "free-ai-photo-editor", path: "free-ai-photo-editor", count: 42 },
      { name: "Free AI Image Enhancer", tag: "free-ai-image-enhancer", path: "free-ai-image-enhancer", count: 40 },
      { name: "Free AI Image Upscaler", tag: "free-ai-image-upscaler", path: "free-ai-image-upscaler", count: 44 },
      { name: "Free AI Photo Filter", tag: "free-ai-photo-filter", path: "free-ai-photo-filter", count: 48 },
      { name: "Free AI Photo Restoration", tag: "free-ai-photo-restoration", path: "free-ai-photo-restoration", count: 44 },
      { name: "Free AI Eraser", tag: "free-ai-eraser", path: "free-ai-eraser", count: 71 },
      { name: "Free AI Background Remover", tag: "free-ai-background-remover", path: "free-ai-background-remover", count: 46 },
      { name: "Free AI Product Photography", tag: "free-ai-product-photography", path: "free-ai-product-photography", count: 45 },
      { name: "Free AI Avatar Generator", tag: "free-ai-avatar-generator", path: "free-ai-avatar-generator", count: 47 }
    ]
  },
  {
    id: "music-audio",
    ...
    color: "emerald",
    subCategories: [
      { name: "Free AI Audio Editing", tag: "free-ai-audio-editing", path: "free-ai-audio-editing", count: 44 },
      { name: "Free AI Audio Enhancer", tag: "free-ai-audio-enhancer", path: "free-ai-audio-enhancer", count: 2 },
      { name: "Free AI Instrumental Generator", tag: "free-ai-instrumental-generator", path: "free-ai-instrumental-generator", count: 43 },
      { name: "Free AI Mastering", tag: "free-ai-mastering", path: "free-ai-mastering", count: 12 },
      { name: "Free AI Melody Generator", tag: "free-ai-melody-generator", path: "free-ai-melody-generator", count: 27 },
      { name: "Free AI Midi Generator", tag: "free-ai-midi-generator", path: "free-ai-midi-generator", count: 6 },
      { name: "Free AI Music Generator", tag: "free-ai-music-generator", path: "free-ai-music-generator", count: 44 },
      { name: "Free AI Noise Cancellation", tag: "free-ai-noise-cancellation", path: "free-ai-noise-cancellation", count: 40 },
      { name: "Free AI Singing Generator", tag: "free-ai-singing-generator", path: "free-ai-singing-generator", count: 31 },
      { name: "Free AI Song Generator", tag: "free-ai-song-generator", path: "free-ai-song-generator", count: 47 },
      { name: "Free AI Sound Effect Generator", tag: "free-ai-sfx-generator", path: "free-ai-sfx-generator", count: 44 },
      { name: "Free AI Vocal Remover", tag: "free-ai-vocal-remover", path: "free-ai-vocal-remover", count: 46 },
      { name: "Free AI Podcast", tag: "free-ai-podcast", path: "free-ai-podcast", count: 20 },
      { name: "Free AI Speech-to-Text", tag: "free-ai-speech-to-text", path: "free-ai-speech-to-text", count: 41 },
      { name: "Free AI Text-to-Speech", tag: "free-ai-text-to-speech", path: "free-ai-text-to-speech", count: 21 },
      { name: "Free AI Transcription", tag: "free-ai-transcription", path: "free-ai-transcription", count: 19 },
      { name: "Free AI Speech Recognition", tag: "free-ai-speech-recognition", path: "free-ai-speech-recognition", count: 46 },
      { name: "Free AI Voice Cloning", tag: "free-ai-voice-cloning", path: "free-ai-voice-cloning", count: 47 },
      { name: "Free AI Voice Enhancer", tag: "free-ai-voice-enhancer", path: "free-ai-voice-enhancer", count: 11 },
      { name: "Free AI Voice Generator", tag: "free-ai-voice-generator", path: "free-ai-voice-generator", count: 47 },
      { name: "Free AI Voice Over", tag: "free-ai-voice-over", path: "free-ai-voice-over", count: 20 },
      { name: "Free Audio To Text AI", tag: "free-audio-to-text", path: "free-audio-to-text", count: 13 },
      { name: "Free AI Audio Splitter", tag: "free-ai-audio-splitter", path: "free-ai-audio-splitter", count: 15 },
      { name: "Free AI Beat Generator", tag: "free-ai-beat-generator", path: "free-ai-beat-generator", count: 28 },
      { name: "Free AI Lyrics Generator", tag: "free-ai-lyrics-generator", path: "free-ai-lyrics-generator", count: 48 },
      ...
      { name: "Free AI Song Cover", tag: "free-ai-song-cover", path: "free-ai-song-cover", count: 42 },
      ...
      { name: "Free AI Stems Splitter", tag: "free-ai-stems-splitter", path: "free-ai-stems-splitter", count: 37 },
      { name: "Free AI Text-to-Music", tag: "free-ai-text-to-music", path: "free-ai-text-to-music", count: 49 },
      { name: "Free Chord AI", tag: "free-chord-ai", path: "free-chord-ai", count: 3 }
    ]
  },
  {
    id: "video-generator",
    ...
    color: "emerald",
    subCategories: [
      { name: "Free AI Video Generator", tag: "free-ai-video-generator", path: "free-ai-video-generator", count: 14 },
      { name: "Free AI Animation Generator", tag: "free-ai-animation-generator", path: "free-ai-animation-generator", count: 12 },
      { name: "Free Image to Video", tag: "free-image-to-video", path: "free-image-to-video", count: 11 },
      { name: "Free Text to Video", tag: "free-text-to-video", path: "free-text-to-video", count: 19 },
      { name: "Free AI Avatar Video Generator", tag: "free-ai-avatar-video-generator", path: "free-ai-avatar-video-generator", count: 11 },
      { name: "Free AI Lip Sync Generator", tag: "free-ai-lip-sync-generator", path: "free-ai-lip-sync-generator", count: 33 },
      { name: "Free AI Face Swap Video", tag: "free-ai-face-swap-video", path: "free-ai-face-swap-video", count: 43 },
      { name: "Free Script To Video AI Generator", tag: "free-script-to-video", path: "free-script-to-video", count: 35 },
      { name: "Free AI Commercial Generator", tag: "free-ai-commercial-generator", path: "free-ai-commercial-generator", count: 16 },
      { name: "Free AI Video Editor", tag: "free-ai-video-editor", path: "free-ai-video-editor", count: 15 },
      { name: "Free AI Video Enhancer", tag: "free-ai-video-enhancer", path: "free-ai-video-enhancer", count: 11 },
      { name: "Free AI Video Upscaler", tag: "free-ai-video-upscaler", path: "free-ai-video-upscaler", count: 12 },
      { name: "Free AI UGC Video Generator", tag: "free-ai-ugc-video-generator", path: "free-ai-ugc-video-generator", count: 28 },
      { name: "Free Video to Video", tag: "free-video-to-video", path: "free-video-to-video", count: 8 },
      { name: "Free AI TikTok Video Generator", tag: "free-ai-tiktok-generator", path: "free-ai-tiktok-generator", count: 42 },
      { name: "Free AI YouTube Video Maker", tag: "free-ai-youtube-maker", path: "free-ai-youtube-maker", count: 8 },
      { name: "Free AI Short Video Generator", tag: "free-ai-short-video", path: "free-ai-short-video", count: 43 },
      { name: "Free AI Reel Generator", tag: "free-ai-reel-generator", path: "free-ai-reel-generator", count: 37 }
    ]
  },
  {
    id: "developer-tools",
  ...
  },
  {
    ...
    subCategories: [
      ...
      { name: "Specialized Artistic Styles", tag: "ai-art-specialized", path: "ai-art-specialized", count: 4 },
      { name: "AI Editing & Stock Tools", tag: "ai-editing-stock", path: "ai-editing-stock", count: 19 },
      { name: "AI Design & Presentations", tag: "ai-design-presentation", path: "ai-design-presentation", count: 13 },
      { name: "AI Logo & Brand Identity", tag: "ai-logo-brand", path: "ai-logo-brand", count: 11 },
      ...
      { name: "AI Visual & Mockup Generators", tag: "ai-visual-mockup", path: "ai-visual-mockup", count: 13 },
      { name: "AI Web & E-commerce", tag: "ai-web-ecommerce", path: "ai-web-ecommerce", count: 7 },
      ...
      { name: "Photo Editing & Retouching", tag: "ai-photo-editing", path: "ai-photo-editing", count: 4 },
      { name: "Vector & SVG Creation", tag: "ai-vector-svg", path: "ai-vector-svg", count: 2 },
      { name: "Storytelling & AI Stories", tag: "ai-storytelling", path: "ai-storytelling", count: 12 },
      { name: "Coloring & Activity Pages", tag: "ai-coloring-pages", path: "ai-coloring-pages", count: 4 },
      { name: "Invitation & Event Solutions", tag: "ai-invitation-events", path: "ai-invitation-events", count: 15 },
      { name: "Specialized & Niche AI", tag: "ai-niche-tools", path: "ai-niche-tools", count: 7 },
      { name: "AI Illustration Generators", tag: "ai-illustration-generators", path: "ai-illustration-generators", count: 10 },
      { name: "AI 3D Model Generators", tag: "ai-3d-modeling", path: "ai-3d-modeling", count: 12 },
      { name: "AI 2D to 3D Conversion", tag: "ai-2d-to-3d", path: "ai-2d-to-3d", count: 5 },
      ...
      { name: "3D Rendering & Visualization", tag: "ai-3d-rendering-viz", path: "ai-3d-rendering-viz", count: 3 },
