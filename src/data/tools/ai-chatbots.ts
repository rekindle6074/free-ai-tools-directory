...
export const ai_chatbots_tools: Record<string, Tool[]> = {
  "free-ai-chatbot": [
    {
      "id": "deepseek-chat",
      "name": "DeepSeek",
  ...
  "free-ai-character": [
    ...
    {
      "id": "basedlabs-character",
      "name": "BasedLabs AI Character Generator",
  ...
  "free-ai-anime-girlfriend": [
    {
      "id": "gpt-anime-companion",
