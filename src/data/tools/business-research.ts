...
export const business_research_tools: Record<string, Tool[]> = {
  "free-ai-business-name-generator": [
    ...
    {
      id: "bisibyte-business-name-generator",
    ...
    {
      id: "usernamegenerator-io",
      name: "UsernameGenerator.IO",
    ...
    {
      id: "itsalreadytaken-com",
      name: "ItsAlreadyTaken.com",
  ...
  "free-ai-crypto": [
    ...
    {
      id: "ai-seed-phrase-finder",
      name: "AI Seed Phrase Finder",
    ...
    {
      id: "coins-crypto-trading-forecast",
      name: "Coins: Crypto Trading Forecast",
    ...
    {
      id: "isitsafe-io-bear-market-busters",
      name: "isitsafe.io & Bear Market Busters",
    ...
    {
      id: "zenai-international-corp",
      name: "ZenAI International Corp",
    ...
    {
      id: "intelligent-ai-world",
      name: "Intelligent AI World",
    ...
    {
      id: "ai-in-action-book",
      name: "AI In Action Book",
    ...
    {
      id: "qwip-consult-ai-experts",
      name: "QWIP - Consult AI experts",
    ...
    {
      id: "agents4future-a4f-",
      name: "Agents4Future (A4F)",
    ...
    {
      id: "cal-com-fernando-mendes-",
      name: "Cal.com (Fernando Mendes)",
    ...
    {
      id: "the-double-a-framework",
      name: "The Double A framework",
      description: "Platform mentioned in the sources as part of the consulting category.",
      category: "Business Research",
  ...
  "free-web3": [
    ...
    {
      id: "blockfence-browser-extension",
      name: "Blockfence Browser Extension",
    ...
    {
      id: "stable-capital-pro",
      name: "Stable Capital Pro",
  ...
  "free-blockchain": [
    ...
    {
      id: "blockbeats-search",
      name: "BlockBeats Search",
  ...
  "free-ai-company-name-generator": [
    {
      id: "anymark",
      name: "Anymark",
      description: "Offers a Free-forever plan allowing users to preview a selection of over 100 logo designs.",
