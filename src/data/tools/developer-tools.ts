...
export const developer_tools_tools: Record<string, Tool[]> = {
  "free-ai-code-assistant": [
    {
      "id": "github-copilot-assistant",
      "name": "GitHub Copilot",
    ...
    {
      "id": "gemini-code-assist-assistant",
    ...
    {
      "id": "google-antigravity-assistant",
  ...
  "free-ai-code-generator": [
    ...
    {
      "id": "gemini-code-assist-generator",
      "name": "Gemini Code Assist",
  ...
  "web-scraping": [
    ...
    {
      "id": "my-email-extractor-scraping",
      "name": "My Email Extractor",
    ...
    {
      "id": "ai-powered-web-scraper-scraping",
    ...
    {
      "id": "instant-data-scraper-scraping",
