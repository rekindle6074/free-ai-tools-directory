...
export const education_translation_tools: Record<string, Tool[]> = {
  "ai-education": [
    {
      "id": "socratic-google",
  ...
  "ai-intelligent-search": [
    ...
    {
      "id": "free-ai-answer-gen",
      "name": "Free AI Answer Generator",
  ...
  "ai-mathematics": [
    ...
    {
      "id": "mathaicalculator-com",
      "name": "Mathaicalculator.com",
    ...
    {
      "id": "practice-times-tables-ai",
      "name": "Practice Times Tables With AI",
    ...
    {
      "id": "math-expression-drawer",
      "name": "Math Expression Drawer",
  ...
  "ai-translation": [
    ...
    {
      "id": "phrase-localization",
      "name": "Phrase Localization Platform",
    ...
    {
      "id": "precise-ai-translator",
      "name": "Precise AI Document Translator",
    ...
    {
      "id": "transmonkey-translate",
      "name": "Transmonkey AI Translator Suite",
    ...
    {
      "id": "subtranslateai-com",
      "name": "SubTranslateAI.com",
    ...
    {
      "id": "machinetranslation-com",
      "name": "MachineTranslation.com",
    ...
    {
      "id": "ai-rosetta",
      "name": "AI Automatic Translation Rosetta",
