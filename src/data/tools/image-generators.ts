...
export const image_generators_tools: Record<string, Tool[]> = {
  "free-ai-product-photography": [
    ...
    {
      "id": "square-photo-studio",
      "name": "Photo Studio by Square",
  ...
  "free-ai-eraser": [
    ...
    {
      "id": "pipiads-text-remover",
      "name": "Pipiads AI Text Remover",
    ...
    {
      "id": "bear-eraser",
      "name": "Bear Eraser - AI Remove Object",
    ...
    {
      "id": "smoothrase",
      "name": "Smoothrase - AI erase on photo",
    ...
    {
      "id": "pixalto-enhancer",
      "name": "Pixalto AI Photo Enhancer",
    ...
    {
      "id": "imgkits-eraser",
      "name": "Imgkits - Top AI Image & Video Processing Tools",
    ...
    {
      "id": "blend-eraser",
      "name": "Blend: AI Background Eraser & Photo Editor",
  ...
  "free-ai-image-enhancer": [
    ...
    {
      "id": "image-upscaling-net",
      "name": "image-upscaling.net",
  ...
  "free-ai-image-upscaler": [
    ...
    {
      "id": "image-upscaling-net-upscaler",
      "name": "image-upscaling.net",
    ...
    {
      "id": "photorestore-upscaler",
      "name": "PhotoRestore.io",
    ...
    {
      "id": "aiimageupscale-com",
      "name": "AIImageUpscale.com",
  ...
  "free-ai-photo-restoration": [
    ...
    {
      "id": "restorephotos-pro",
      "name": "restorePhotos.Pro",
    ...
    {
      "id": "hitpaw-fotorpea-restoration",
      "name": "HitPaw FotorPea",
    ...
    {
      "id": "nanobanana-online-restoration",
    ...
    {
      "id": "image-upscaling-net-restoration",
      "name": "image-upscaling.net",
  ...
  "free-ai-photo-filter": [
    ...
    {
      "id": "ghibli-ai-generator",
      "name": "Ghibli AI Image Generator",
    ...
    {
      "id": "clay-style-online",
      "name": "Image to Clay Style Online",
    ...
    {
      "id": "ai-disturbance-filter",
      "name": "AI Disturbance Overlay",
    ...
    {
      "id": "remini-filter",
      "name": "AI Photo Enhancer: Filter Art",
