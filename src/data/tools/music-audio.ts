...
export const music_audio_tools: Record<string, Tool[]> = {
  ...
  "free-ai-instrumental-generator": [
    ...
    {
      "id": "ai-music-maker-musicmakerapp-",
      "name": "AI Music Maker (MusicMakerApp)",
    ...
    {
      "id": "make-song-ai-song-generator",
    ...
    {
      "id": "muza-ai-ai-song-music",
      "name": "Muza AI: AI Song & Music",
    ...
    {
      "id": "story321-music-ai",
      "name": "Story321 Music AI",
  ...
  "free-ai-mastering": [
    ...
    {
      "id": "diktatorial-suite",
      "name": "DIKTATORIAL Suite",
    ...
    {
      "id": "mastermallow-ai-audio-mastering",
      "name": "Mastermallow AI Audio Mastering",
  ...
  "free-ai-melody-generator": [
    {
      "id": "ai-music-creator-text-to-song",
      "name": "AI Music Creator: Text to Song",
  ...
  "free-ai-music-generator": [
    ...
    {
      "id": "supermaker-ai-video-generator",
  ...
  "free-ai-noise-cancellation": [
    ...
    {
      "id": "aiarty-image-matting",
      "name": "Aiarty Image Matting",
    ...
    {
      "id": "easeus-vocal-remover",
      "name": "EaseUS Vocal Remover",
    ...
    {
      "id": "fliflik-voice-changer",
      "name": "FliFlik Voice Changer",
  ...
  "free-ai-singing-generator": [
        ...
        {
            "id": "songbot-ai-music-singing",
            "name": "SongBot AI Music",
  ...
  "free-ai-song-generator": [
        ...
        {
            "id": "ai-music-generator-generator",
            "name": "AI Music Generator",
        ...
        {
            "id": "ai-song-generator-generator",
            "name": "AI Song Generator",
        ...
        {
            "id": "lyrics-to-song-ai-generator",
            "name": "Lyrics To Song AI",
            "description": "Offers a free trial to transform lyrics into songs with professional vocals and multi-genre support.",
            "category": "Music Generator",
            "link": "https://lyricstosong.io/",
        ...
        {
            "id": "make-song-ai-song-generator-generator",
            "name": "Make Song-AI Song Generator",
        ...
        {
            "id": "story321-music-ai-generator",
            "name": "Story321 Music AI",
        ...
        {
            "id": "suno-ai-music-generator-ai-musical--generator",
            "name": "Suno AI Music Generator (AI Musical)",
        ...
        {
            "id": "vozart-ai-music-lyrics-generator-generator",
            "name": "Vozart AI Music & Lyrics Generator",
  ...
  "free-ai-sfx-generator": [
        ...
        {
            "id": "beatviz-ai-the-ultimate-ai-music-video-generator-sfx",
        ...
        {
            "id": "clockalarmonline-sfx",
            "name": "ClockAlarmOnline",
        ...
        {
            "id": "imagine-studios-ai-sfx",
            "name": "IMAGINE Studios AI",
        ...
        {
            "id": "sound-effects-ai-sfx",
            "name": "Sound Effects AI",
        ...
        {
            "id": "suno-everything-sfx",
            "name": "Suno Everything",
        ...
        {
            "id": "veo-3-1-ai-video-generator-sfx",
        ...
        {
            "id": "vozart-ai-music-lyrics-generator-sfx",
            "name": "Vozart AI Music & Lyrics Generator",
        ...
        {
            "id": "wondershare-tomoviee-ai-sfx",
            "name": "WonderShare ToMoviee AI",
  ...
  "free-ai-vocal-remover": [
        ...
        {
            "id": "ai-music-generator-vocal-remover",
            "name": "AI Music Generator",
            "description": "Allows 2 free music generations per day to create unique songs from text or lyrics.",
            "category": "Vocal Remover",
            "link": "https://musicgeneratorai.com/",
        ...
        {
            "id": "ai-song-maker-vocal-remover",
            "name": "AI Song Maker",
            "description": "Offers 10 free credits per month to generate royalty-free music effortlessly.",
            "category": "Vocal Remover",
            "link": "https://www.aisongmaker.io/",
        ...
        {
            "id": "ai-voice-generator-by-aivocal-vocal-remover",
        ...
        {
            "id": "audio-enhancer-vocal-remover",
            "name": "Audio Enhancer",
        ...
        {
            "id": "easeus-vocal-remover-vocal-remover",
            "name": "EaseUS Vocal Remover",
        ...
        {
            "id": "generator-ai-music-vocal-remover",
        ...
        {
            "id": "make-song-ai-song-generator-vocal-remover",
            "name": "Make Song-AI Song Generator",
        ...
        {
            "id": "makebestmusic-vocal-remover",
            "name": "MakeBestMusic",
            "description": "Provides 3 free AI music credits for text-to-music generation, splitting, and remixing.",
            "category": "Vocal Remover",
            "link": "https://makebestmusic.com/",
        ...
        {
            "id": "minimax-audio-vocal-remover",
            "name": "MiniMax Audio",
        ...
        {
            "id": "mykaraoke-video-vocal-remover",
            "name": "MyKaraoke Video",
        ...
        {
            "id": "online-audio-converter-vocal-remover",
            "name": "Online Audio Converter",
        ...
        {
            "id": "remover-studio-vocal-remover",
            "name": "Remover.studio",
        ...
        {
            "id": "songgenerator-io-vocal-remover",
            "name": "SongGenerator.io",
            "description": "Provides 20 free credits per day for text-to-music generation, lyrics creation, and vocal removal.",
            "category": "Vocal Remover",
            "link": "https://songgenerator.io/",
        ...
        {
            "id": "vocal-remover-oak-vocal-remover",
            "name": "Vocal Remover Oak",
        ...
        {
            "id": "voice-isolator-vocal-remover",
            "name": "Voice Isolator",
        ...
        {
            "id": "wondershare-filmora-vocal-remover",
            "name": "Wondershare Filmora",
        ...
        {
            "id": "wondershare-uniconverter-vocal-remover",
            "name": "Wondershare UniConverter",
  ...
  "free-ai-speech-to-text": [
    ...
    {
      "id": "ai-translation-rosetta-stt",
      "name": "AI Translation Rosetta",
    ...
    {
      "id": "transcribetotext-ai-stt",
      "name": "TranscribeToText.AI",
  ...
  "free-ai-speech-recognition": [
    ...
    {
      "id": "audio-recognition-services",
      "name": "Audio Recognition Services",
    ...
    {
      "id": "cpait-chinese",
      "name": "CPAIT-Chinese Pronunciation AI",
    ...
    {
      "id": "transcriptionplus",
      "name": "TranscriptionPlus",
    ...
    {
      "id": "chinese-ai-u",
      "name": "Chinese AI - U Language Coach",
    ...
    {
      "id": "voice-typing-extension",
      "name": "Voice Typing Extension",
  ...
  "free-ai-voice-cloning": [
    ...
    {
      "id": "fineshare-finevoice-cloning",
    ...
    {
      "id": "blipcut-ai-cloning",
      "name": "BlipCut AI Video Translator",
    ...
    {
      "id": "respeecher-voice-marketplace-cloning",
      "name": "Respeecher Voice Marketplace",
    ...
    {
      "id": "free-voice-cloning",
      "name": "Free Voice Cloning",
    ...
    {
      "id": "clonemyvoice-io-cloning",
      "name": "clonemyvoice.io",
  ...
  "free-ai-voice-enhancer": [
    {
      "id": "vocal-image-enhancer",
      "name": "Vocal Image",
  ...
  "free-ai-voice-generator": [
    ...
    {
      "id": "deepgram-ai-voice",
      "name": "Deepgram AI Voice Generator",
    ...
    {
      "id": "respeecher-voice-marketplace-voice",
      "name": "Respeecher Voice Marketplace",
  ...
  "free-ai-voice-over": [
    ...
    {
      "id": "fineshare-finevoice-voiceover",
      "name": "Fineshare FineVoice",
  ...
  "free-audio-to-text": [
    ...
    {
      "id": "transcribe-me-audio-to-text",
      "name": "TranscribeMe",
    ...
    {
      "id": "go-transcript-audio-to-text",
      "name": "GoTranscript",
  ...
  "free-ai-beat-generator": [
    ...
    {
      "id": "binaural-beats-factory",
      "name": "Binaural Beats Factory",
  ...
  "free-ai-lyrics-generator": [
    ...
    {
      "id": "free-ai-song-lyrics-generator",
      "name": "Free AI Song Lyrics Generator",
    ...
    {
      "id": "lyricsgenerator-com",
      "name": "LyricsGenerator.com",
    ...
    {
      "id": "ourquote-generator",
      "name": "ourquote generator",
    ...
    {
      "id": "suno-ai-lyrics-generator",
      "name": "Suno AI Lyrics Generator",
    ...
    {
      "id": "vozart-ai-music-lyrics-generator",
      "name": "Vozart AI Music & Lyrics Generator",
  ...
  "free-ai-rap-generator": [
      ...
      {
          "id": "ai-rap-song-generator-app",
          "name": "AI Rap Song Generator",
  ...
  "free-ai-rap-lyrics-generator": [
      ...
      {
          "id": "ai-rap-song-generator-lyrics",
          "name": "AI Rap Song Generator",
      ...
      {
          "id": "ai-song-lyrics-generator-chrome",
          "name": "Free AI Song Lyrics Generator",
  ...
  "free-ai-song-cover": [
      ...
      {
          "id": "audio-ai-dynamics-aaid-song-cover",
          "name": "Audio AI Dynamics - AAID",
      ...
      {
          "id": "diktatorial-suite-song-cover",
          "name": "DIKTATORIAL Suite",
      ...
      {
          "id": "mastermallow-ai-audio-mastering-song-cover",
          "name": "Mastermallow AI Audio Mastering",
      ...
      {
          "id": "mix-check-studio-song-cover",
          "name": "Mix Check Studio",
      ...
      {
          "id": "online-audio-converter-song-cover",
          "name": "Online Audio Converter",
      ...
      {
          "id": "sound-effects-ai-song-cover",
          "name": "Sound Effects AI",
  ...
  "free-ai-song-remixer": [
      {
          "id": "ai-music-maker-remixer",
          "name": "AI Music Maker",
          "description": "Offers 60 free credits for new users to generate music from text or images.",
  ...
  "free-ai-splitter": [
      ...
      {
          "id": "best-video-trimmer-cutter-for-chrome-splitter",
          "name": "Best Video Trimmer & Cutter for Chrome",
      ...
      {
          "id": "make-song-ai-song-generator-splitter",
          "name": "Make Song-AI Song Generator",
      ...
      {
          "id": "smart-media-cutter-splitter",
          "name": "Smart Media Cutter",
  ...
  "free-ai-stems-splitter": [
      {
          "id": "ai-song-creator-stems",
      ...
      {
          "id": "vozart-ai-music-lyrics-generator-stems",
          "name": "Vozart AI Music & Lyrics Generator",
  ...
  "free-ai-text-to-music": [
      {
          "id": "a-v-mapping-txt2music",
          "name": "A.V. Mapping",
      ...
      {
          "id": "ai-music-generator-txt2music",
          "name": "AI Music Generator",
      ...
      {
          "id": "ai-song-generator-txt2music",
          "name": "AI Song Generator",
      ...
      {
          "id": "aimusic-generator-txt2music",
          "name": "AIMusic Generator",
      ...
      {
          "id": "generator-ai-music-txt2music",
          "name": "Generator AI Music",
      ...
      {
          "id": "lami-ai-free-ai-music-generator-from-text-txt2music",
      ...
      {
          "id": "lyrics-to-song-ai-txt2music",
          "name": "Lyrics to Song AI",
      ...
      {
          "id": "media-io-halloween-ai-generator-txt2music",
      ...
      {
          "id": "sound-effect-generator-txt2music",
          "name": "Sound Effect Generator",
      ...
      {
          "id": "story321-music-ai-txt2music",
          "name": "Story321 Music AI",
          "description": "Offers 4 free songs for AI music generation with custom style selection.",
          "category": "Text-to-Music",
          "link": "https://story321.com/music",
