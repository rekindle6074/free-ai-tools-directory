...
export const office_productivity_tools: Record<string, Tool[]> = {
  "ai-smart-productivity": [
    ...
    {
      "id": "chatgpt-mega-prompts",
      "name": "200+ ChatGPT Mega-Prompts",
  ...
  "ai-file-management": [
    ...
    {
      "id": "malware-ai",
      "name": "Malware.AI Browser Security",
  ...
  "ai-search": [
    ...
    {
      "id": "free-ai-search-engine",
      "name": "Free AI Search Engine",
