...
export const medicalTools: Record<string, Tool[]> = {
  "free-ai-dermatology": [
    {
        "id": "skinive",
        "name": "Skinive",
  ...
  "free-ai-healthcare": [
    ...
    {
        "id": "cannabiva-cbd-dosage-calculator",
    ...
    {
        "id": "hair-transplant-ai-success",
        "name": "Hair Transplant AI Success",
  ...
  "free-ai-medical-diagnosis": [
    ...
    {
        "id": "dr-gupta-ai-physician-chatbot",
        "name": "Dr. Gupta: AI Physician Chatbot",
    ...
    {
        "id": "meducator-medical-ai",
        "name": "Meducator - Medical AI",
        "description": "A free mobile application that provides essential AI-driven medical diagnosis features with optional premium updates.",
        "category": "Smart Medical Directory",
  ...
  "free-ai-mental-health": [
    ...
    {
        "id": "abby-your-ai-therapist",
        "name": "Abby - Your AI Therapist",
    ...
    {
        "id": "elissa-my-panic-ally",
        "name": "Elissa - My Panic Ally",
    ...
    {
        "id": "distortion-catcher",
        "name": "Distortion Catcher",
        "description": "Offers a freemium model that allows users to explore basic AI-powered mental health features for free.",
        "category": "Smart Medical Directory",
    ...
    {
        "id": "mental-strengthen-your-mind",
        "name": "Mental: Strengthen Your Mind",
        "description": "A free mobile application that provides essential AI-driven mental health features with optional premium updates.",
        "category": "Smart Medical Directory",
    ...
    {
        "id": "sanctuary-meditation-sleep",
        "name": "Sanctuary: Meditation & Sleep",
        "description": "Offers a freemium model that allows users to explore basic AI-powered mental health features for free.",
        "category": "Smart Medical Directory",
  ...
  "free-ai-symptom-checker": [
    ...
    {
        "id": "mole-similarity-chrome-extension",
        "name": "Mole Similarity Chrome Extension",
  ...
  "free-ai-therapist": [
    ...
    {
        "id": "disertus-labs-milo-ai-speech-therapist-",
        "name": "Disertus Labs (Milo AI Speech Therapist)",
        "description": "Offers a freemium model that allows users to explore basic AI-powered therapist features for free.",
        "category": "Smart Medical Directory",
    ...
    {
        "id": "thoughts-cbt-ai-therapy",
        "name": "Thoughts - CBT AI therapy",
    ...
    {
        "id": "sober-counter-therapy-rise",
        "name": "Sober Counter & Therapy - Rise",
        "description": "A free mobile application that provides essential AI-driven therapist features with optional premium updates.",
        "category": "Smart Medical Directory",
    ...
    {
        "id": "you-need-a-therapist",
        "name": "You Need A Therapist",
    ...
    {
        "id": "flint-therapy-chatbot",
        "name": "Flint - Therapy Chatbot",
        "description": "A free mobile application that provides essential AI-driven therapist features with optional premium updates.",
        "category": "Smart Medical Directory",
