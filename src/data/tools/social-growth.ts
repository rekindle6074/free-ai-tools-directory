...
export const social_growth_tools: Record<string, Tool[]> = {
  "free-ai-bio-generator": [
    {
      "id": "hullo-ai-bio-generator",
    ...
    {
      "id": "10x-tech-infinity",
      "name": "10x Tech Infinity",
      "description": "Provides a freemium plan with limited daily usage to explore professional AI-driven bio generator features.",
      "category": "Social Growth Hub",
    ...
    {
      "id": "resumepro",
      "name": "ResumePro - CV/COVERLETTER APP",
      "description": "A free-to-download mobile application offering essential AI bio generator tools for users on the go.",
      "category": "Social Growth Hub",
    ...
    {
      "id": "cosmic",
      "name": "Cosmic: Insightful Dating App",
      "description": "A free-to-download mobile application offering essential AI bio generator tools for users on the go.",
      "category": "Social Growth Hub",
    ...
    {
      "id": "interview-prep-now",
      "name": "Interview Prep Now",
      "description": "Provides a freemium plan with limited daily usage to explore professional AI-driven bio generator features.",
      "category": "Social Growth Hub",
    ...
    {
      "id": "character-headcanon-generator",
  ...
  "free-ai-facebook": [
    ...
    {
        "id": "facebook-marketplace-auto-reply-extension",
        "name": "Facebook Marketplace Auto Reply Extension",
        "description": "A free-to-install browser extension providing essential AI facebook tools for your workflow.",
        "category": "Social Growth Hub",
    ...
    {
        "id": "find-lost-vehicle",
        "name": "Find Lost Vehicle",
        "description": "Provides a freemium plan with limited daily usage to explore professional AI-driven facebook features.",
        "category": "Social Growth Hub",
    ...
    {
        "id": "imagetocaption-ai",
        "name": "imagetocaption.ai",
        "description": "Provides a freemium plan with limited daily usage to explore professional AI-driven facebook features.",
        "category": "Social Growth Hub",
    ...
    {
        "id": "socialmate-ai-creator",
        "name": "SocialMate AI Creator",
        "description": "Provides a freemium plan with limited daily usage to explore professional AI-driven facebook features.",
        "category": "Social Growth Hub",
    ...
    {
        "id": "didoo-ai-url-in-meta-ads-out-one-click-to-outp-",
        "name": "Didoo AI - URL in, Meta ads out. One Click to Outp...",
        "description": "Provides a freemium plan with limited daily usage to explore professional AI-driven facebook features.",
        "category": "Social Growth Hub",
        "link": "https://didoo.ai/",
    ...
    {
        "id": "socialboost-ad-manager",
        "name": "SocialBoost Ad Manager",
        "description": "A free-to-install browser extension providing essential AI facebook tools for your workflow.",
        "category": "Social Growth Hub",
  ...
  "free-ai-hashtag": [
    ...
    {
        "id": "ai-stock-keywords",
        "name": "AI Stock Keywords",
    ...
    {
        "id": "free-ai-wedding-hashtag-generator",
        "name": "Free AI Wedding Hashtag Generator",
        "description": "Provides a freemium plan with limited daily usage to explore professional AI-driven hashtag features.",
        "category": "Social Growth Hub",
    ...
    {
        "id": "monteracreative-com",
        "name": "monteracreative.com",
    ...
    {
        "id": "ai-image-to-caption-generator",
        "name": "AI Image to Caption Generator",
        "description": "A free-to-download mobile application offering essential AI hashtag tools for users on the go.",
        "category": "Social Growth Hub",
  ...
  "free-ai-influencer": [
    ...
    {
        "id": "forgefluencer-com",
        "name": "forgefluencer.com",
    ...
    {
        "id": "aiinactionbook-com",
        "name": "aiinactionbook.com",
    ...
    {
        "id": "fortytwotalks-com",
        "name": "fortytwotalks.com",
  ...
  "free-ai-instagram-caption-generator": [
    ...
    {
        "id": "cool-caption-ideas",
        "name": "Cool Caption Ideas",
    ...
    {
        "id": "captions-for-photos-captioned",
        "name": "Captions for photos: Captioned",
    ...
    {
        "id": "ai-photocaption-text-generator",
        "name": "AI PhotoCaption—Text Generator",
        "description": "Provides a freemium plan with limited daily usage to explore professional AI-driven instagram caption generator features.",
        "category": "Social Growth Hub",
  ...
  "free-ai-instagram": [
    ...
    {
        "id": "myinstapersonality-com",
        "name": "myinstapersonality.com",
    ...
    {
        "id": "instagram-summit-2023",
        "name": "Instagram Summit 2023",
        "description": "Provides a freemium plan with limited daily usage to explore professional AI-driven instagram features.",
        "category": "Social Growth Hub",
    ...
    {
        "id": "comment-generator-for-instagram",
    ...
    {
        "id": "moji-ai-chat-content-ai",
        "name": "Moji AI - Chat & Content AI",
        "description": "A free-to-download mobile application offering essential AI instagram tools for your users on the go.",
        "category": "Social Growth Hub",
  ...
  "free-ai-meme-generator": [
    ...
    {
        "id": "roastthatface-com",
        "name": "roastthatface.com",
    ...
    {
        "id": "tweetgrok-twitter-creation-and-growth-assistant",
    ...
    {
        "id": "piccraft-ai-picture-maker",
        "name": "PicCraft - AI Picture Maker",
  ...
  "free-ai-tiktok": [
    ...
    {
        "id": "tiktok-customer-service-helper",
        "name": "Tiktok Customer Service Helper",
        "description": "A free-to-install browser extension providing essential AI tiktok tools for your workflow.",
        "category": "Social Growth Hub",
    ...
    {
        "id": "reverie-unique-things-to-do",
        "name": "Reverie - Unique Things to Do",
  ...
  "free-ai-twitter": [
    ...
    {
        "id": "ai-community-notes",
        "name": "AI Community Notes",
        "description": "A free-to-install browser extension providing essential AI twitter tools for your workflow.",
        "category": "Social Growth Hub",
  ...
  "free-ai-youtube-summary": [
    ...
    {
        "id": "youtubesummarized",
        "name": "Youtubesummarized",
    ...
    {
        "id": "ai-summarizer-for-youtube",
        "name": "AI Summarizer for YouTube",
        "description": "Provides a freemium plan with limited daily usage to explore professional AI-driven youtube summary features.",
        "category": "Social Growth Hub",
    ...
    {
        "id": "youtube-video-summarizer-vidsum-",
        "name": "YouTube Video Summarizer (VidSum)",
    ...
    {
        "id": "seed-chrome-extension",
        "name": "Seed Chrome Extension",
        "description": "Provides a freemium plan with limited daily usage to explore professional AI-driven youtube summary features.",
        "category": "Social Growth Hub",
    ...
    {
        "id": "videonotestldr-com",
        "name": "videonotestldr.com",
    ...
    {
        "id": "youtube-summary-with-chatgpt-awesum-",
        "name": "YouTube Summary with ChatGPT (Awesum)",
        "description": "A free-to-install browser extension providing essential AI youtube summary tools for your workflow.",
        "category": "Social Growth Hub",
    ...
    {
        "id": "youtube-video-summarizer-summify-",
        "name": "YouTube Video Summarizer (Summify)",
        "description": "A free-to-install browser extension providing essential AI youtube summary tools for your workflow.",
        "category": "Social Growth Hub",
    ...
    {
        "id": "youtube-summary-chatgpt-",
        "name": "YouTube Summary (ChatGPT)",
        "description": "A free-to-install browser extension providing essential AI youtube summary tools for your workflow.",
        "category": "Social Growth Hub",
    ...
    {
        "id": "chatgpt-for-chrome-youtube-summary",
  ...
  "free-ai-youtube-thumbnail-generator": [
    ...
    {
        "id": "ai-youtube-thumbnail-generator",
  ...
  "free-ai-youtube": [
    ...
    {
        "id": "youtube-video-tag-extension",
        "name": "YouTube Video Tag Extension",
        "description": "A free-to-install browser extension providing essential AI youtube tools for your workflow.",
        "category": "Social Growth Hub",
    ...
    {
        "id": "seo-roast-youtube-title-maker",
        "name": "SEO Roast YouTube Title Maker",
        "description": "Provides a freemium plan with limited daily usage to explore professional AI-driven youtube features.",
        "category": "Social Growth Hub",
  ...
  "free-ai-youtube-tags-generator": [
    {
        "id": "vidiq",
        "name": "Vidiq",
        "description": "Offers 3 free video ideas, 3 thumbnail generations, and 3 keyword research uses for AI-powered optimization.",
    ...
    {
        "id": "free-ai-tags-generator-for-youtube",
        "name": "Free AI Tags Generator for YouTube",
        "description": "A free-to-install browser extension providing essential AI free youtube tags generator tools for your workflow.",
        "category": "Social Growth Hub",
    ...
    {
        "id": "mind-meld-canvas-ai",
        "name": "Mind Meld Canvas AI",
        "description": "Provides a freemium plan with limited daily usage to explore professional AI-driven free youtube tags generator features.",
        "category": "Social Growth Hub",
