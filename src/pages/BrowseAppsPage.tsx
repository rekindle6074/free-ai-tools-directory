    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <MemberToolsGuard 
          ...
          categoryTitle="l'ensemble du catalogue"
          customMessage="La navigation dans l'annuaire complet des outils et l'accès à leurs liens directs sont exclusivement réservés aux utilisateurs enregistrés. Les inscriptions publiques sont actuellement suspendues."
        >
