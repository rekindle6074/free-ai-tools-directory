    ...
    <>
      ...
      <div className="min-h-screen bg-slate-50 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <MemberToolsGuard
            toolCount={favoriteTools.length}
            categoryTitle="vos favoris personnalisés"
            customMessage="L'accès à votre espace personnel de favoris et la consultation des fiches d'outils sauvegardées sont réservés aux utilisateurs enregistrés. Les inscriptions publiques sont actuellement suspendues."
          >
            {loading ? (
