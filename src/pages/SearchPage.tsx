          ...
          <div className="space-y-20">
            ...
            {results.some(r => r.type === "tool") && (
              <div>
                ...
                <MemberToolsGuard
                  toolCount={results.filter(r => r.type === "tool").length}
                  categoryTitle="les résultats de recherche"
                  customMessage="L'accès aux cartes des outils trouvés et à leurs liens officiels est exclusivement réservé aux utilisateurs enregistrés. Les inscriptions publiques sont actuellement suspendues."
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    {results.filter(r => r.type === "tool").map((result) => (
