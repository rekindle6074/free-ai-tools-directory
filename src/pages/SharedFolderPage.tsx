  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start mb-12">
        ...
        {(() => {
          const colorCfg = getFolderColor(sharedData.color);
          return (
            <div className={`lg:col-span-1 bg-white rounded-[2.5rem] border p-8 shadow-sm ${colorCfg.cardClass}`}>
              ...
              <h1 className="text-3xl font-black text-slate-950 tracking-tight leading-none mb-4 flex items-center gap-3">
                <FolderHeart className="w-8 h-8 text-slate-850 shrink-0" />
                {sharedData.name}
              </h1>
        ...
        <div className="lg:col-span-2">
          <MemberToolsGuard
            ...
            categoryTitle={`la collection partagée "${sharedData.name}"`}
            customMessage="La consultation des cartes d'outils et l'accès direct aux services répertoriés dans cette collection sont réservés aux utilisateurs enregistrés. Les inscriptions publiques sont actuellement suspendues."
          >
